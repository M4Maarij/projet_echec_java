...
// test Echec et mat
    ...
    private  void update() {
        ...
        Iterator<Roi> var1 = Roi.tabRoi.iterator();

        while(true) {
            while(var1.hasNext()) {
                Roi var2 = (Roi)var1.next();
                String var3 = var2.update();
                Couleur var4 = var2.getCouleur();
                if (var2.echec && !var2.echecEtMat) {
                    System.out.println("le roi " + var2.getCouleur() + " est en echec");
                } else if (var2.echec && var2.echecEtMat || var2.echecEtPat) {
                    this.fini = true;
                    System.out.println("le roi " + var2.couleur + " est en " + var3 + "\n");
                    if (var4.equals(Couleur.WHITE)) {
